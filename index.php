...
<head>
    ...
    <title>My First CRUD Application By Sammy</title>
...
<div class="container"style="background-color: cyan">
    <header class="header">
        ...
        <p>By <a href="//www.w3jar.com">Trapper</a></p>
    </header>
    <div class="wrapper"style="background-color: #0d6efd">
        <div class="form">
            <form method="POST">
                ...
                <table>
                    ...
                    <?php foreach ($all_user as $user) :
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $id; ?>" class="edit"style="background-color: #dc3545">Edit</a>&nbsp;|
